  ...
  return (
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-black from-black/60 via-black/80 to-black"></div>
        ...
        <div className="relative mx-auto flex h-full max-w-7xl items-center px-6">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-gray-300">
              ...
              Explore luxury villas, premium apartments,
              commercial offices and investment opportunities
              across India's most desirable locations.
  ...
  <div className="rounded-3xl border border-green-500/20 bg-zinc-900/90 backdrop-blur-xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
    ...
    <div className="grid gap-5 lg:grid-cols-5">
      ...
      <input
        ...
        className="rounded-2xl border border-zinc-700 bg-black px-5 outline-none transition focus:border-green-500"
      />
      ...
      <button className="rounded-2xl bg-green-500 font-bold text-black transition hover:bg-green-400">
...
<div className="grid gap-10 lg:grid-cols-[300px_1fr]">
  ...
  <div>
    ...
    {/* PROPERTY GRID STARTS IN PART 3 */}
  ...
  {filteredProperties.map((property) => (
    ...
    <div
      key={property.id}
      className="group overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-black from-zinc-900 to-black shadow-xl transition-all duration-500 hover:-translate-y-2 hover:border-green-500 hover:shadow-[0_20px_60px_rgba(34,197,94,0.25)]"
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-teal from-black via-transparent to-transparent"></div>
        ...
        <button
          onClick={() =>
            setCurrentImage({
              ...currentImage,
              [property.id]:
                currentImage[property.id] < property.images.length - 1
                  ? (currentImage[property.id] || 0) + 1
                  : 0,
            })
          }
                ...
                <button
                  ...
                  className={`h-12 w-12 rounded-xl font-bold transition ${
                    page === 1
                      ...
                      : "border border-zinc-700 bg-zinc-900 hover:border-green-500"
                  }`}
                >
                  {page}
                </button>
      ...
      <section className="mx-auto mt-28 max-w-7xl px-6">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-5xl font-bold">
            ...
            India's Leading Developers

          </h2>

          <p className="mt-5 text-gray-400">

            We collaborate with the country's most trusted real estate brands.
        ...
        <div className="mt-14 grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6">
          ...
          {[
            ...
            <div
              key={company}
              className="rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-center transition hover:border-green-500 hover:-translate-y-1"
            >
      ...
      <section className="mx-auto mt-28 max-w-7xl px-6">
        ...
        <div className="rounded-3xl border border-green-500/20 bg-zinc-900 p-12">
          ...
          <div className="text-center">
            ...
            <p className="uppercase tracking-[6px] text-green-500">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl border border-zinc-800 bg-black p-8 text-center transition hover:border-green-500"
              >
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative px-10 py-24 text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-gray-300">
              ...
              real estate, or looking for luxury living, GO REALTORS is here
              to make your journey simple, transparent, and memorable.
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-5">
              ...
              <Link
                to="/signup"
                className="rounded-xl bg-green-500 px-10 py-4 font-bold text-black transition hover:bg-green-400"
              >
                Book Consultation
              </Link>
              ...
              <Link
                to="/contact"
                className="rounded-xl border border-green-500 px-10 py-4 font-bold text-green-400 transition hover:bg-green-500 hover:text-black"
              >
                Contact Us
              </Link>
